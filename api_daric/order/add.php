...
$sqlQuery = "INSERT INTO orders_table SET user_id='$userID',
selectedItems='$selectedItems', deliverySystem='$deliverySystem',
paymentSystem='$paymentSystem', cardName='$cardName', cardNo='$cardNo',
cardExp='$cardExp', cardCVV='$cardCVV',
note='$note', totalAmount='$totalAmount',
image='$image', status='$status', shipmentAddress='$shipmentAddress',
